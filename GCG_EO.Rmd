...
During the final session of Earth Observation, we will organize a mini-symposium. We kindly ask the presenting groups to **upload their presentation in advance**. Presentations must consist of **at most 6 slides** and include project background and study area, a comprehensive graph of the project workflow, three main results, as well as three discussion items. 

The schedule is very tight and presenters are urged to strictly stay within pre-defined time slots. For every group, an **oral presentation of at most 10 minutes** is foreseen. Presentations exceeding this time limit will be interrupted. The conference organizers further grant a maximum of 5 minutes for discussion. 
