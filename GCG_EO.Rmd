...
Your project work will result in a written homework in the style of a scientific article. The written work should follow the typical structure of a scientific paper (Abstract, Introduction, Data & Methods, Results, Discussion, and Conclusion). Feel free to screen online materials for [scientific writing guidelines](https://writingajournalarticle.wordpress.com/). 

The work should contain a maximum of 20,000 characters (not counting spaces, references, and appendix). The appendix may contain additional materials such as figures, tables, and code for the main analyses.

To allow for transparent grading, we kindly ask you to disentangle the individual contributions in a tabular format containing:
