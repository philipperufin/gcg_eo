...
Similar to the above exercise, assess the area-adjusted accuracy estimates of the results of assignment 5.6). Next, compare overall and class-wise accuracies. Can you find a notable difference in the performance of RF versus SVM classification? If so, which?
