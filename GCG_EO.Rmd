...
<!-- # Session 11: Project phase II

## Learning goals:

- Convert raw satellite data to analysis-ready level 3 datasets
...
### 2) Further processing to produce level 3 data
...
**Until next week:** Prepare your presentation in PowerPoint and PDF format and upload them as a *.zip file on moodle the latest on July 2.
